...
export module telecrap:Responce;
...
export namespace telecrap
{
	...
	struct Responce
	{
		...
		/// </summary>
		static Responce CreateError(const char* message, ErrorCode errorCode = ErrorCode::OK);
		
		/// <summary>
		/// Создает error-ответ из string_view.
		/// </summary>
		static Responce CreateError(const std::string_view& message, ErrorCode errorCode = ErrorCode::OK);
